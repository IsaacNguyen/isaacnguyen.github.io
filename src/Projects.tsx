...
function Projects() {
    ...
    return (
      <div className='mb-10'>
        ...
        <div className="fade-in-image flex flex-wrap w-full mx-0 mt-10 justify-center">
            <div className='flex w-2/3 flex-col'>
              <div className='flex mb-10 w-full h-1/6 top-0 justify-center text-lg sm:text-xl md:text-2xl '>
                  ...
                  <div className='grid grid-cols-1 2xl:grid-cols-2 gap-x-10 gap-y-10'>
                      ...
                      name="Spotr"
                      description='Helping people familiarize themselves with their surroundings by ungatekeeping "spots".'
